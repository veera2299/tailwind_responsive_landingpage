...
import Img1 from "../../assets/top_products/shirt.png";
import Img2 from "../../assets/top_products/shirt2.png";
import Img3 from "../../assets/top_products/shirt3.png";
    ...
    <div>
      <div className='container'>
        ...
        <div className='text-left mb-24'>
            <p data-aos = "fade-up" className='text-sm text-primary'>Top products for you</p>
            <h1 data-aos = "fade-up"  className='text3xl font-bold'>Best Products</h1>
            <p data-aos = "fade-up"  className='text-xs text-gray-500'> consectetur adipisicing elit. Velit, rerum.</p>
        </div>
        {/* Body Section */}
